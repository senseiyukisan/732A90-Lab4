...
$$P(\vec\mu|\vec{Y}) \propto exp \Bigg{[} -\frac{1}{2\sigma^2} \bigg{(} \sum_{i=1}^{n}({y_i}-{\mu_i})^2 + \sum_{i = 1}^{n-1}({\mu_{i+1}}-{\mu_i})^2 \bigg{)} \Bigg{]} \propto exp \Bigg{[} -\frac{1}{2\sigma^2} \bigg{(} \sum^{n-1}_{i=1} \big{[} (\mu_i - \mu_{i+1})^2 + (\mu_i -  y_i)^2 \big{]}a + (\mu_n - y_n)^2 \big{)} \Bigg{]}$$
...
$$P(\mu_1 | \vec\mu_{-1},\vec Y) \propto exp \Bigg{[} -\frac{1}{2\sigma^2} \bigg{[}  (\mu_1- \mu_2)^2 + (\mu_2 - y_1)^2  \bigg{]} \Bigg{]}$$
...
$$P(\mu_i | \vec\mu_{-i},\vec Y) \propto exp \Bigg{[} -\frac{1}{2\sigma^2} \bigg{[}  (\mu_{i-1}- \mu_{i})^2+ (\mu_i- \mu_{i+1})^2 + (\mu_{i} - y_1)^2  \bigg{]} \Bigg{]}$$
